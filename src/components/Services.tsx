    ...
    <section id="services" className="pt-32 pb-24 px-6 md:px-12 bg-[#050505]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div>
            <h2 className="text-amber-500 font-futuristic font-bold tracking-widest mb-4 uppercase text-xs">
              Products & Supply Range
            </h2>
            <h3 className="text-4xl md:text-6xl font-futuristic font-bold leading-tight uppercase tracking-tighter italic">
              INFRASTRUCTURE <br />
          ...
          <div className="max-w-sm glass p-8 rounded-3xl border-amber-500/20">
            <p className="text-gray-400 text-sm italic font-light">
              "From construction machinery to highway safety systems, we deliver durable and performance-driven infrastructure solutions built to modern engineering standards."
            </p>
        ...
        <div className="mb-20 glass rounded-[3rem] p-6 md:p-12 border border-amber-500/30 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6 text-center md:text-left">
              <div>
                <h4 className="text-xl md:text-2xl font-futuristic font-bold text-white mb-2 uppercase tracking-tighter italic">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-10">
              <input 
                type="text"
                placeholder="Example: Requirement for W-Beam crash barriers for 2km highway stretch..."
            ...
            {customResult && (
              <div className="animate-in fade-in slide-in-from-top-4 duration-500 p-8 rounded-3xl bg-amber-500/5 border border-amber-500/20 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="flex-grow">
                  ...
                  <h5 className="text-2xl font-bold font-futuristic text-white mb-3 italic uppercase">
                    {customResult.name}
                  </h5>
                  <p className="text-gray-400 text-sm max-w-lg italic font-light leading-relaxed">
                    "{customResult.description}"
                  </p>
                </div>

                <div className="flex flex-col items-center md:items-end gap-3 min-w-[180px]">
                  <span className="text-4xl font-bold font-futuristic text-white">
                    ₹{customResult.price}
                  </span>
                  <span className="text-xs text-gray-500 mb-4 uppercase tracking-widest font-bold">
              ...
              <div className="flex flex-col justify-between py-2 flex-grow">
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <span className="text-[8px] font-bold text-amber-500 tracking-[0.3em] uppercase bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">
                      {s.category}
                    </span>
                    <span className="text-[9px] text-gray-500 font-futuristic uppercase tracking-widest font-bold">
                      {s.duration}
                    </span>
                  </div>

                  <h4 className="text-xl md:text-2xl font-bold font-futuristic mb-3 group-hover:text-amber-500 transition-colors uppercase tracking-tight italic leading-tight">
                    {s.name}
                  </h4>

                  <p className="text-gray-400 text-xs leading-relaxed mb-6 font-light line-clamp-3 italic">
                    "{s.description}"
                  </p>
                </div>
                
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
                  <span className="text-2xl font-bold font-futuristic tracking-tighter">
                    ₹{s.price}
                  </span>
                  <button 
                    onClick={() => onBook(s)}
